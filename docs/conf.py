...
html_theme_options = {
    ...
    'github_repo': 'invenio-workflows',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links': {
        'invenio-workflows@GitHub':
            'http://github.com/inveniosoftware-contrib/invenio-workflows',
        'invenio-workflows@PyPI':
            'http://pypi.python.org/pypi/invenio-workflows/',
    }
}
...
htmlhelp_basename = 'invenio-workflows_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-workflows.tex', u'invenio-workflows Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-workflows', u'invenio-workflows Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-workflows', u'invenio-workflows Documentation',
   author, 'invenio-workflows', 'Invenio module for running workflows.',
   'Miscellaneous'),
]
