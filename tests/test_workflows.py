...
"""
    ...
    def test_workflow_for_finished_object(self):
        ...
        workflow = start(workflow_name="demo_workflow", data=[current])
        ...
        workflow_2 = start(workflow_name="demo_workflow", data=[previous])
    ...
    def test_continue_execution_for_object(self):
        ...
        init_workflow = start("demo_workflow", data=[initial_data])
    ...
    def test_restart_failed_workflow(self):
        ...
        with self.assertRaises(WorkflowError):
            start(workflow_name="demo_workflow_error", data=[initial_data])
