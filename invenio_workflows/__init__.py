...
`obj` (:py:class:`invenio_workflows.models.DbWorkflowObject`)
...
The former use the :py:class:`invenio_workflows.models.DbWorkflowObject` model API, and
...
:py:class:`invenio_workflows.models.DbWorkflowObject`
...
If you need to add some extra data to the :py:class:`invenio_workflows.models.DbWorkflowObject` that is
...
This information is used by the :py:class:`invenio_workflows.models.DbWorkflowObject` to store some additional
